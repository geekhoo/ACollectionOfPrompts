# dxAccordion
This prompt equips a coding agent with the steps to instantiate the **dxAccordion** widget using the bundled assets.
...
<script>
  $(function() {
    $('#accordion').dxAccordion({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxAccordion ready', e.component)
    });
  });
</script>
```
