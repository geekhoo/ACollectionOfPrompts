# dxTextArea
This prompt equips a coding agent with the steps to instantiate the **dxTextArea** widget using the bundled assets.
...
<script>
  $(function() {
    $('#textArea').dxTextArea({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTextArea ready', e.component)
    });
  });
</script>
```
