# dxContextMenu
This prompt equips a coding agent with the steps to instantiate the **dxContextMenu** widget using the bundled assets.
...
<script>
  $(function() {
    $('#contextMenu').dxContextMenu({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxContextMenu ready', e.component)
    });
  });
</script>
```
