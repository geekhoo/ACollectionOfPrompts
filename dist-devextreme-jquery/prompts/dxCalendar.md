# dxCalendar
This prompt equips a coding agent with the steps to instantiate the **dxCalendar** widget using the bundled assets.
...
<script>
  $(function() {
    $('#calendar').dxCalendar({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxCalendar ready', e.component)
    });
  });
</script>
```
