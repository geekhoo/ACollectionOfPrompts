# dxTooltip
This prompt equips a coding agent with the steps to instantiate the **dxTooltip** widget using the bundled assets.
...
<script>
  $(function() {
    $('#tooltip').dxTooltip({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTooltip ready', e.component)
    });
  });
</script>
```
