# dxSplitter
This prompt equips a coding agent with the steps to instantiate the **dxSplitter** widget using the bundled assets.
...
<script>
  $(function() {
    $('#splitter').dxSplitter({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSplitter ready', e.component)
    });
  });
</script>
```
