# dxRadioGroup
This prompt equips a coding agent with the steps to instantiate the **dxRadioGroup** widget using the bundled assets.
...
<script>
  $(function() {
    $('#radioGroup').dxRadioGroup({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxRadioGroup ready', e.component)
    });
  });
</script>
```
