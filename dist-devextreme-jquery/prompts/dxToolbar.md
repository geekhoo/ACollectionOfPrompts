# dxToolbar
This prompt equips a coding agent with the steps to instantiate the **dxToolbar** widget using the bundled assets.
...
<script>
  $(function() {
    $('#toolbar').dxToolbar({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxToolbar ready', e.component)
    });
  });
</script>
```
