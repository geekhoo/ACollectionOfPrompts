# dxGallery
This prompt equips a coding agent with the steps to instantiate the **dxGallery** widget using the bundled assets.
...
<script>
  $(function() {
    $('#gallery').dxGallery({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxGallery ready', e.component)
    });
  });
</script>
```
