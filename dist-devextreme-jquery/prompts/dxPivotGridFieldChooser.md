...
This prompt equips a coding agent with the steps to instantiate the **dxPivotGridFieldChooser** widget using the bundled assets.
...
<div id="pivotGridFieldChooser"></div>
...
<script>
  $(function() {
    $('#pivotGridFieldChooser').dxPivotGridFieldChooser({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxPivotGridFieldChooser ready', e.component)
    });
  });
</script>
```
