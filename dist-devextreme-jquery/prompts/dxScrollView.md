# dxScrollView
This prompt equips a coding agent with the steps to instantiate the **dxScrollView** widget using the bundled assets.
...
<script>
  $(function() {
    $('#scrollView').dxScrollView({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxScrollView ready', e.component)
    });
  });
</script>
```
