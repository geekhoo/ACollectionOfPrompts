# dxNumberBox
This prompt equips a coding agent with the steps to instantiate the **dxNumberBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#numberBox').dxNumberBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxNumberBox ready', e.component)
    });
  });
</script>
```
