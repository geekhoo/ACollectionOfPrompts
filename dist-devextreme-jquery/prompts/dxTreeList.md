# dxTreeList
This prompt equips a coding agent with the steps to instantiate the **dxTreeList** widget using the bundled assets.
...
<script>
  $(function() {
    $('#treeList').dxTreeList({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTreeList ready', e.component)
    });
  });
</script>
```
