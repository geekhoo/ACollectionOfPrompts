# dxFileManager
This prompt equips a coding agent with the steps to instantiate the **dxFileManager** widget using the bundled assets.
...
<script>
  $(function() {
    $('#fileManager').dxFileManager({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxFileManager ready', e.component)
    });
  });
</script>
```
