# dxButtonGroup
This prompt equips a coding agent with the steps to instantiate the **dxButtonGroup** widget using the bundled assets.
...
<script>
  $(function() {
    $('#buttonGroup').dxButtonGroup({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxButtonGroup ready', e.component)
    });
  });
</script>
```
