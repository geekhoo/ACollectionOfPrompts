# dxDataGrid
This prompt equips a coding agent with the steps to instantiate the **dxDataGrid** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dataGrid').dxDataGrid({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDataGrid ready', e.component)
    });
  });
</script>
```
