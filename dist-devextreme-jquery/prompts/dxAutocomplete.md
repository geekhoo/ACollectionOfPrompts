# dxAutocomplete
This prompt equips a coding agent with the steps to instantiate the **dxAutocomplete** widget using the bundled assets.
...
<script>
  $(function() {
    $('#autocomplete').dxAutocomplete({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxAutocomplete ready', e.component)
    });
  });
</script>
```
