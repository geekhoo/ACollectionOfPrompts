# dxForm
This prompt equips a coding agent with the steps to instantiate the **dxForm** widget using the bundled assets.
...
<script>
  $(function() {
    $('#form').dxForm({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxForm ready', e.component)
    });
  });
</script>
```
