# dxTileView
This prompt equips a coding agent with the steps to instantiate the **dxTileView** widget using the bundled assets.
...
<script>
  $(function() {
    $('#tileView').dxTileView({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTileView ready', e.component)
    });
  });
</script>
```
