# dxValidationMessage
This prompt equips a coding agent with the steps to instantiate the **dxValidationMessage** widget using the bundled assets.
...
<script>
  $(function() {
    $('#validationMessage').dxValidationMessage({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxValidationMessage ready', e.component)
    });
  });
</script>
```
