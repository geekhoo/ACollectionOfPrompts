# dxSwitch
This prompt equips a coding agent with the steps to instantiate the **dxSwitch** widget using the bundled assets.
...
<script>
  $(function() {
    $('#switch').dxSwitch({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSwitch ready', e.component)
    });
  });
</script>
```
