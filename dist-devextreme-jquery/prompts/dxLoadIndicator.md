# dxLoadIndicator
This prompt equips a coding agent with the steps to instantiate the **dxLoadIndicator** widget using the bundled assets.
...
<script>
  $(function() {
    $('#loadIndicator').dxLoadIndicator({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxLoadIndicator ready', e.component)
    });
  });
</script>
```
