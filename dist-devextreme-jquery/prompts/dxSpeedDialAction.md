# dxSpeedDialAction
This prompt equips a coding agent with the steps to instantiate the **dxSpeedDialAction** widget using the bundled assets.
...
<script>
  $(function() {
    $('#speedDialAction').dxSpeedDialAction({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSpeedDialAction ready', e.component)
    });
  });
</script>
```
