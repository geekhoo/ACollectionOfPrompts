# dxTreeView
This prompt equips a coding agent with the steps to instantiate the **dxTreeView** widget using the bundled assets.
...
<script>
  $(function() {
    $('#treeView').dxTreeView({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTreeView ready', e.component)
    });
  });
</script>
```
