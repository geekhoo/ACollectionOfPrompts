# dxTrackBar
This prompt equips a coding agent with the steps to instantiate the **dxTrackBar** widget using the bundled assets.
...
<script>
  $(function() {
    $('#trackBar').dxTrackBar({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTrackBar ready', e.component)
    });
  });
</script>
```
