# dxList
This prompt equips a coding agent with the steps to instantiate the **dxList** widget using the bundled assets.
...
<script>
  $(function() {
    $('#list').dxList({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxList ready', e.component)
    });
  });
</script>
```
