# dxRecurrenceEditor
This prompt equips a coding agent with the steps to instantiate the **dxRecurrenceEditor** widget using the bundled assets.
...
<script>
  $(function() {
    $('#recurrenceEditor').dxRecurrenceEditor({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxRecurrenceEditor ready', e.component)
    });
  });
</script>
```
