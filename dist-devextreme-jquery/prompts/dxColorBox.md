# dxColorBox
This prompt equips a coding agent with the steps to instantiate the **dxColorBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#colorBox').dxColorBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxColorBox ready', e.component)
    });
  });
</script>
```
