# dxDrawer
This prompt equips a coding agent with the steps to instantiate the **dxDrawer** widget using the bundled assets.
...
<script>
  $(function() {
    $('#drawer').dxDrawer({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDrawer ready', e.component)
    });
  });
</script>
```
