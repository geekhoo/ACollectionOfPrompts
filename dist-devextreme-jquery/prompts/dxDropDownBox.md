# dxDropDownBox
This prompt equips a coding agent with the steps to instantiate the **dxDropDownBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dropDownBox').dxDropDownBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDropDownBox ready', e.component)
    });
  });
</script>
```
