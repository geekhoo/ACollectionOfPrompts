# dxPivotGrid
This prompt equips a coding agent with the steps to instantiate the **dxPivotGrid** widget using the bundled assets.
...
<script>
  $(function() {
    $('#pivotGrid').dxPivotGrid({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxPivotGrid ready', e.component)
    });
  });
</script>
```
