# dxPagination
This prompt equips a coding agent with the steps to instantiate the **dxPagination** widget using the bundled assets.
...
<script>
  $(function() {
    $('#pagination').dxPagination({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxPagination ready', e.component)
    });
  });
</script>
```
