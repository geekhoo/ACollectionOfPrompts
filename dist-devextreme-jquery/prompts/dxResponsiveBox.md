# dxResponsiveBox
This prompt equips a coding agent with the steps to instantiate the **dxResponsiveBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#responsiveBox').dxResponsiveBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxResponsiveBox ready', e.component)
    });
  });
</script>
```
