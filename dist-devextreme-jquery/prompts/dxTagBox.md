# dxTagBox
This prompt equips a coding agent with the steps to instantiate the **dxTagBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#tagBox').dxTagBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTagBox ready', e.component)
    });
  });
</script>
```
