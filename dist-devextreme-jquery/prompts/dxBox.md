# dxBox
This prompt equips a coding agent with the steps to instantiate the **dxBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#box').dxBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxBox ready', e.component)
    });
  });
</script>
```
