# dxTabPanel
This prompt equips a coding agent with the steps to instantiate the **dxTabPanel** widget using the bundled assets.
...
<script>
  $(function() {
    $('#tabPanel').dxTabPanel({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTabPanel ready', e.component)
    });
  });
</script>
```
