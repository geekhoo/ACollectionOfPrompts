# dxDateRangeBox
This prompt equips a coding agent with the steps to instantiate the **dxDateRangeBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dateRangeBox').dxDateRangeBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDateRangeBox ready', e.component)
    });
  });
</script>
```
