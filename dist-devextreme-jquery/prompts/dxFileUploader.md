# dxFileUploader
This prompt equips a coding agent with the steps to instantiate the **dxFileUploader** widget using the bundled assets.
...
<script>
  $(function() {
    $('#fileUploader').dxFileUploader({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxFileUploader ready', e.component)
    });
  });
</script>
```
