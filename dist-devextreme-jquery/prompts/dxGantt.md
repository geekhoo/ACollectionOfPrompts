# dxGantt
This prompt equips a coding agent with the steps to instantiate the **dxGantt** widget using the bundled assets.
...
<script>
  $(function() {
    $('#gantt').dxGantt({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxGantt ready', e.component)
    });
  });
</script>
```
