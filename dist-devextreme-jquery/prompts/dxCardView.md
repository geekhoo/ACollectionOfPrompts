# dxCardView
This prompt equips a coding agent with the steps to instantiate the **dxCardView** widget using the bundled assets.
...
<script>
  $(function() {
    $('#cardView').dxCardView({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxCardView ready', e.component)
    });
  });
</script>
```
