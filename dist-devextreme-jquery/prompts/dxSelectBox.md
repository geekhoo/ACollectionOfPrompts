# dxSelectBox
This prompt equips a coding agent with the steps to instantiate the **dxSelectBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#selectBox').dxSelectBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSelectBox ready', e.component)
    });
  });
</script>
```
