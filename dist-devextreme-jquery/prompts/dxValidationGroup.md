# dxValidationGroup
This prompt equips a coding agent with the steps to instantiate the **dxValidationGroup** widget using the bundled assets.
...
<script>
  $(function() {
    $('#validationGroup').dxValidationGroup({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxValidationGroup ready', e.component)
    });
  });
</script>
```
