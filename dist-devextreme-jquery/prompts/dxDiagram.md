# dxDiagram
This prompt equips a coding agent with the steps to instantiate the **dxDiagram** widget using the bundled assets.
...
<script>
  $(function() {
    $('#diagram').dxDiagram({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDiagram ready', e.component)
    });
  });
</script>
```
