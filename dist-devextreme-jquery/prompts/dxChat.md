# dxChat
This prompt equips a coding agent with the steps to instantiate the **dxChat** widget using the bundled assets.
...
<script>
  $(function() {
    $('#chat').dxChat({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxChat ready', e.component)
    });
  });
</script>
```
