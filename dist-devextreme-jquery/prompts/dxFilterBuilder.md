# dxFilterBuilder
This prompt equips a coding agent with the steps to instantiate the **dxFilterBuilder** widget using the bundled assets.
...
<script>
  $(function() {
    $('#filterBuilder').dxFilterBuilder({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxFilterBuilder ready', e.component)
    });
  });
</script>
```
