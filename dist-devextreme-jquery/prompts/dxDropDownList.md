# dxDropDownList
This prompt equips a coding agent with the steps to instantiate the **dxDropDownList** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dropDownList').dxDropDownList({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDropDownList ready', e.component)
    });
  });
</script>
```
