# dxValidator
This prompt equips a coding agent with the steps to instantiate the **dxValidator** widget using the bundled assets.
...
<script>
  $(function() {
    $('#validator').dxValidator({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxValidator ready', e.component)
    });
  });
</script>
```
