# dxLoadPanel
This prompt equips a coding agent with the steps to instantiate the **dxLoadPanel** widget using the bundled assets.
...
<script>
  $(function() {
    $('#loadPanel').dxLoadPanel({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxLoadPanel ready', e.component)
    });
  });
</script>
```
