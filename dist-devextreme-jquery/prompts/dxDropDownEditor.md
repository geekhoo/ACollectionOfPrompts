# dxDropDownEditor
This prompt equips a coding agent with the steps to instantiate the **dxDropDownEditor** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dropDownEditor').dxDropDownEditor({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDropDownEditor ready', e.component)
    });
  });
</script>
```
