# dxMenu
This prompt equips a coding agent with the steps to instantiate the **dxMenu** widget using the bundled assets.
...
<script>
  $(function() {
    $('#menu').dxMenu({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxMenu ready', e.component)
    });
  });
</script>
```
