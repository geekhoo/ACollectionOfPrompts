# dxOverlay
This prompt equips a coding agent with the steps to instantiate the **dxOverlay** widget using the bundled assets.
...
<script>
  $(function() {
    $('#overlay').dxOverlay({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxOverlay ready', e.component)
    });
  });
</script>
```
