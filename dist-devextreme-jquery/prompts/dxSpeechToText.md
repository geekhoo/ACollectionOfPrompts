# dxSpeechToText
This prompt equips a coding agent with the steps to instantiate the **dxSpeechToText** widget using the bundled assets.
...
<script>
  $(function() {
    $('#speechToText').dxSpeechToText({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSpeechToText ready', e.component)
    });
  });
</script>
```
