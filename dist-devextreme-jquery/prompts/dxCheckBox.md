# dxCheckBox
This prompt equips a coding agent with the steps to instantiate the **dxCheckBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#checkBox').dxCheckBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxCheckBox ready', e.component)
    });
  });
</script>
```
