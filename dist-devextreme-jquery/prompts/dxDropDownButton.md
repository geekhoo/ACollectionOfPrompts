# dxDropDownButton
This prompt equips a coding agent with the steps to instantiate the **dxDropDownButton** widget using the bundled assets.
...
<script>
  $(function() {
    $('#dropDownButton').dxDropDownButton({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDropDownButton ready', e.component)
    });
  });
</script>
```
