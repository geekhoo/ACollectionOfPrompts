# dxHtmlEditor
This prompt equips a coding agent with the steps to instantiate the **dxHtmlEditor** widget using the bundled assets.
...
<script>
  $(function() {
    $('#htmlEditor').dxHtmlEditor({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxHtmlEditor ready', e.component)
    });
  });
</script>
```
