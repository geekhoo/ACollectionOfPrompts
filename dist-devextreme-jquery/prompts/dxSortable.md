# dxSortable
This prompt equips a coding agent with the steps to instantiate the **dxSortable** widget using the bundled assets.
...
<script>
  $(function() {
    $('#sortable').dxSortable({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSortable ready', e.component)
    });
  });
</script>
```
