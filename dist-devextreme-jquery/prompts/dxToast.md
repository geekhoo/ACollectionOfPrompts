# dxToast
This prompt equips a coding agent with the steps to instantiate the **dxToast** widget using the bundled assets.
...
<script>
  $(function() {
    $('#toast').dxToast({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxToast ready', e.component)
    });
  });
</script>
```
