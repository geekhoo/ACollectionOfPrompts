# dxTabs
This prompt equips a coding agent with the steps to instantiate the **dxTabs** widget using the bundled assets.
...
<script>
  $(function() {
    $('#tabs').dxTabs({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTabs ready', e.component)
    });
  });
</script>
```
