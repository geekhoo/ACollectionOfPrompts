# dxProgressBar
This prompt equips a coding agent with the steps to instantiate the **dxProgressBar** widget using the bundled assets.
...
<script>
  $(function() {
    $('#progressBar').dxProgressBar({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxProgressBar ready', e.component)
    });
  });
</script>
```
