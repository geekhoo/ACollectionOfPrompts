# dxRangeSlider
This prompt equips a coding agent with the steps to instantiate the **dxRangeSlider** widget using the bundled assets.
...
<script>
  $(function() {
    $('#rangeSlider').dxRangeSlider({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxRangeSlider ready', e.component)
    });
  });
</script>
```
