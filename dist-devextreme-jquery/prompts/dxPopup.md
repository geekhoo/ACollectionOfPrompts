# dxPopup
This prompt equips a coding agent with the steps to instantiate the **dxPopup** widget using the bundled assets.
...
<script>
  $(function() {
    $('#popup').dxPopup({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxPopup ready', e.component)
    });
  });
</script>
```
