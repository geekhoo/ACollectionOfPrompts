# dxResizable
This prompt equips a coding agent with the steps to instantiate the **dxResizable** widget using the bundled assets.
...
<script>
  $(function() {
    $('#resizable').dxResizable({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxResizable ready', e.component)
    });
  });
</script>
```
