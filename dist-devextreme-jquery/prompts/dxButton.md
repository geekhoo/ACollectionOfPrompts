# dxButton
This prompt equips a coding agent with the steps to instantiate the **dxButton** widget using the bundled assets.
...
<script>
  $(function() {
    $('#button').dxButton({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxButton ready', e.component)
    });
  });
</script>
```
