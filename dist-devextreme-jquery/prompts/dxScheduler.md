# dxScheduler
This prompt equips a coding agent with the steps to instantiate the **dxScheduler** widget using the bundled assets.
...
<script>
  $(function() {
    $('#scheduler').dxScheduler({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxScheduler ready', e.component)
    });
  });
</script>
```
