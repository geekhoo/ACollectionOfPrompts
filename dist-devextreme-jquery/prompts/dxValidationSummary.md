# dxValidationSummary
This prompt equips a coding agent with the steps to instantiate the **dxValidationSummary** widget using the bundled assets.
...
<script>
  $(function() {
    $('#validationSummary').dxValidationSummary({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxValidationSummary ready', e.component)
    });
  });
</script>
```
