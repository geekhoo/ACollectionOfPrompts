# dxActionSheet
This prompt equips a coding agent with the steps to instantiate the **dxActionSheet** widget using the bundled assets.
...
<script>
  $(function() {
    $('#actionSheet').dxActionSheet({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxActionSheet ready', e.component)
    });
  });
</script>
```
