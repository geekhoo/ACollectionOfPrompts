# dxMultiView
This prompt equips a coding agent with the steps to instantiate the **dxMultiView** widget using the bundled assets.
...
<script>
  $(function() {
    $('#multiView').dxMultiView({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxMultiView ready', e.component)
    });
  });
</script>
```
