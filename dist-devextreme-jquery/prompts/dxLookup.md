# dxLookup
This prompt equips a coding agent with the steps to instantiate the **dxLookup** widget using the bundled assets.
...
<script>
  $(function() {
    $('#lookup').dxLookup({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxLookup ready', e.component)
    });
  });
</script>
```
