# dxMap
This prompt equips a coding agent with the steps to instantiate the **dxMap** widget using the bundled assets.
...
<script>
  $(function() {
    $('#map').dxMap({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxMap ready', e.component)
    });
  });
</script>
```
