# dxPopover
This prompt equips a coding agent with the steps to instantiate the **dxPopover** widget using the bundled assets.
...
<script>
  $(function() {
    $('#popover').dxPopover({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxPopover ready', e.component)
    });
  });
</script>
```
