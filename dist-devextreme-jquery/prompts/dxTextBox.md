# dxTextBox
This prompt equips a coding agent with the steps to instantiate the **dxTextBox** widget using the bundled assets.
...
<script>
  $(function() {
    $('#textBox').dxTextBox({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxTextBox ready', e.component)
    });
  });
</script>
```
