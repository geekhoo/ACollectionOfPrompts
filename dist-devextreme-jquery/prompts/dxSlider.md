# dxSlider
This prompt equips a coding agent with the steps to instantiate the **dxSlider** widget using the bundled assets.
...
<script>
  $(function() {
    $('#slider').dxSlider({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxSlider ready', e.component)
    });
  });
</script>
```
