# dxStepper
This prompt equips a coding agent with the steps to instantiate the **dxStepper** widget using the bundled assets.
...
<script>
  $(function() {
    $('#stepper').dxStepper({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxStepper ready', e.component)
    });
  });
</script>
```
