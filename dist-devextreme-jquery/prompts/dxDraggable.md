# dxDraggable
This prompt equips a coding agent with the steps to instantiate the **dxDraggable** widget using the bundled assets.
...
<script>
  $(function() {
    $('#draggable').dxDraggable({
      width: '100%',
      height: 400,
      onInitialized: (e) => console.log('dxDraggable ready', e.component)
    });
  });
</script>
```
