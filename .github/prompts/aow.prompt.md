---
agent: agent
argument-hint: Provide the prompt you want to strategize with, and I will help you optimize it using Art of War principles.
description: This prompt applies principles from Sun Tzu's *The Art of War* to optimize AI prompts for strategic effectiveness.
---

Read and understand user's input: $INPUT

**If $INPUT is empty, or undiscernible, STOP and reply with a `?`**

Apply *The Art of War* principles to optimize the prompt in $INPUT. Use the following strategies:
...
Using these strategies, optimize the prompt in $INPUT for maximum strategic effectiveness. Provide the optimized prompt as your output.
